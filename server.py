        ...
        <div class="dv-screenshots-inner">
            <div class="dv-screenshot">
                <div class="phone-frame" style="background:#0d1117">
                    <img class="ss-img" src="/static/hero-prob-chart.png" alt="2d6 probability distribution chart">
                    <img class="ss-img" src="/static/hero-prob-result.png" alt="Roll result with probability" style="margin-top:4px">
            ...
            <div class="dv-screenshot">
                <div class="phone-frame" style="background:#0d1117">
                    <img class="ss-img" src="/static/hero-multigroup.png" alt="Multi-group dice formula">
            ...
            <div class="dv-screenshot">
                <div class="phone-frame" style="background:#0d1117">
                    <img class="ss-img" src="/static/hero-custom.png" alt="Custom dice with emoji faces">
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        elif path.startswith("/static/") and path.endswith(".png"):
            fname = path.split("/")[-1]
            if "/" in fname or ".." in fname:
                self.send_error(404)
                return
            try:
                img_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "static", fname)
